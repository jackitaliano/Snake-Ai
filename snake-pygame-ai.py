...
class Snake:
    ...
    def collide(self, display_w, display_h):
        # hits boundary
        if self.head.x > display_w - BLOCK_SIZE or self.head.x < 0 or self.head.y > display_h - BLOCK_SIZE or self.head.y < 0:
            return True
        # hits itself
...
class SnakeGameAI:
    ...
    def play_step(self):
        ...
        game_over = False
        if self.snake.collide(self.w, self.h):
            game_over = True
